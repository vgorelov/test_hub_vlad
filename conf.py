# -*- coding: utf-8 -*-
#
# Sphinx_text documentation build configuration file, created by
...
project = u'Sphinx_text'
copyright = u'2015, vgorelov'
author = u'vgorelov'
...
htmlhelp_basename = 'Sphinx_textdoc'
...
latex_documents = [
  (master_doc, 'Sphinx_text.tex', u'Sphinx\\_text Documentation',
   u'vgorelov', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx_text', u'Sphinx_text Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Sphinx_text', u'Sphinx_text Documentation',
   author, 'Sphinx_text', 'One line description of project.',
   'Miscellaneous'),
]
